...
public class CacheTripleVariables implements Serializable {
	...
	String oo = "-";
	/*
	 * equal Variables = a.subject - b.subject, a.subject - b.predicate,
	 * a.subject - b.object
	 */
	...
	private boolean variablesEqual(CacheTripleVariables cTV){
		...
		if(cTV.ss.equals(ss)&& cTV.sp.equals(sp)&&cTV.so.equals(so)&&
		   cTV.ps.equals(ps)&& cTV.pp.equals(pp)&&cTV.po.equals(po)&&
		   cTV.os.equals(os)&& cTV.op.equals(op)&&cTV.oo.equals(oo) ){
			return true;
		}
		return false;
	}
	...
	public int hashCode() {
		int hc;
		hc = a.hashCode() ^ b.hashCode() ^ 
		     ss.hashCode() ^ sp.hashCode() ^ so.hashCode() ^ 
		     ps.hashCode() ^ pp.hashCode() ^ po.hashCode() ^
		     os.hashCode() ^ op.hashCode() ^ oo.hashCode();
		return hc;
	}
