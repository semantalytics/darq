...
public class JuTestOptimizer6 extends AbstractOptimizerTest {
    ...
    private final Node varO = Node.createVariable("z");
    ...
    //    sg2 = new ServiceGroup(service2);
        ...
        tl1 = new ArrayList<Triple>();
        tl1.add(new Triple(varX,predP,varY));
        tl1.add(new Triple(varY,predQ,varZ));
        tl1.add(new Triple(varZ,predS,varO));
    ...
    public List<ServiceGroup> getExpectedResult() {
        ...
        restriples.add(new Triple(varZ,predS,varO));
        restriples.add(new Triple(varY,predQ,varZ));
        restriples.add(new Triple(varX,predP,varY));
