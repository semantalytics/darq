...
public class JuTestOptimizer5 extends AbstractOptimizerTest {
    ...
    //    sg2 = new ServiceGroup(service2);
        ...
        tl1.add(new Triple(varY,predQ,varX));
        tl1.add(new Triple(varY,predR,varX));
    ...
    public List<ServiceGroup> getExpectedResult() {
        ...
        restriples.add(new Triple(varY,predR,varX));
        restriples.add(new Triple(varY,predQ,varX));
